            ...
            <div class="bg-white dark:bg-gray-800 mb-3 relative shadow-md sm:rounded-lg overflow-hidden">
                            ...
                            <tr v-for="casesss in itemsToDisplay" :key="casesss.id"
                                ...
                                <td class="px-4 py-3 truncate text-right ">
                                    <button type="button" @click="handleDeleteCase(casesss._id)"
                                        data-modal-toggle="delete-user-modal" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
                ...
                <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                    ...
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        Showing
                        <span class="font-semibold text-gray-900 dark:text-white">1-{{ casesss.length< pageSize ? casesss.length : pageSize }}</span>
                        of

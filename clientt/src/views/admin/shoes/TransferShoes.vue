<template>
    <div>
        ...
        <!-- <div class="flex py-3 justify-center items-center  bg-slate-300">
            <form @submit.prevent="handleTransfershoes"
                ...
                <div class="grid gap-3 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input v-model="newshoes.handlingInstructions" name="status" id="status"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-300 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div>
                        <label for="createdBy" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Assigned Officier</label>
                        <input v-model="newshoes.newOfficer" name="createdBy" id="createdBy"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-300 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                </div>
                <button type="sumbit"
        ...
        <div class="flex justify-center pt-0 ">
            <form @submit.prevent="handleTransferShoes" enctype="multipart/form-data"
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" v-model="newShoes.identifier" name="identifier" id="identifier"
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" v-model="newShoes.caseNumber" name="caseNumber" id="caseNumber"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " />
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="newShoes.description" name="description" id="floating_description"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " />
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="newShoes.notes" name="notes" id="notes"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " />
                        <label for="notes"
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" v-model="newShoes.storageLocation" name="storageLocation" id="storageLocation"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " />
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" v-model="newShoes.handlingInstructions" name="handlingInstructions"
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" v-model="newShoes.newOfficer" name="newOfficer"
                        id="newOfficer"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " />
...
export default {
    ...
    methods: {
        async handleTransferShoes() {
            try {
                const response = await axios.put(`http://localhost:3000/shoess/transfer/${this.$route.params.id}`, this.newShoes, {
                    headers: {
                        'Content-Type': 'application/json'
                    }
                });
                this.$router.push('/admin/shoes');
            } catch (error) {
                console.error(error);
            }
        }
    ...
    created() {
        let apiURL = `http://localhost:3000/shoess/${this.$route.params.id}`;

        axios.get(apiURL).then((res) => {
            this.newShoes = res.data;
            this.newShoes.newOfficer= this.newShoes.createdBy
        });
    },
    computed:{
    }

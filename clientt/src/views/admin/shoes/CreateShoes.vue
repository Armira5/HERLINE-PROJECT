...
export default {
    ...
    methods: {
        async handleCreateCase() {
            ...
            this.errors = {};
            let apiURL = "http://localhost:3000/shoes/create";
            const { error, value } = this.shoesSchema.validate(this.newShoes, { abortEarly: false });
            if (error) {
            ...
            formData.append('name', this.newShoes.name);
            formData.append('color', this.newShoes.color);
            formData.append('size', this.newShoes.size);
            formData.append('price', this.newShoes.price);
            formData.append('brand', this.newShoes.brand);
            formData.append('notes', this.newShoes.notes);
            formData.append('status', this.newShoes.status);
            formData.append('photo', this.$refs.fileInput.files[0]);
            formData.append('photoName', this.newShoes.photoName);
        ...
        validateFile(event) {
            ...
            this.newShoes.photoName = `${generateFileName()}.${file.type.split('/')[1]}`;
        },
        clearErrors() {
            this.errors = {};
        },
        ...
        <form @submit.prevent="handleCreateCase" enctype="multipart/form-data" class="w-5/6 lg:w-4/6 xl:w-3/6 flex border-2 border-gray-600 bg-gray-700 p-6 rounded-xl flex-col justify-center">
              ...
              <div class="grid md:grid-cols-2 md:gap-6">
                  <div class="relative z-0 w-full mb-6 group">
                      <input type="text" v-model="newShoes.name" name="name" id="name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  />
                  ...
                  <div class="relative z-0 w-full mb-6 group">
                      <input type="text" v-model="newShoes.color" name="color" id="color" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  />
              ...
              <div class="relative z-0 w-full mb-6 group">
                  <input type="text" v-model="newShoes.size" name="size" id="floating_size" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  />
              ...
              <div class="relative z-0 w-full mb-6 group">
                  <input type="text" v-model="newShoes.price" name="price" id="floating_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  />
              ...
              <div class="grid md:grid-cols-2 md:gap-6">
                <!-- <div class="relative z-0 w-full mb-6 group">
                    <input type="text" v-model="newShoes.brand" name="brand" id="brand" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  />
